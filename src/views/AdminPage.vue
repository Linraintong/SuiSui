...
<template>
  <div class="admin-page">
    ...
    <div class="admin-tabs">
      <button v-if="auth.isAdmin" :class="['tab-item', { active: tab === 'overview' }]" @click="tab = 'overview'">
        <v-icon size="small" class="tab-icon">mdi-view-dashboard</v-icon>
        <span>概览</span>
      </button>
      <button v-if="auth.isAdmin" :class="['tab-item', { active: tab === 'system' }]" @click="tab = 'system'">
        <v-icon size="small" class="tab-icon">mdi-cog</v-icon>
        <span>系统设置</span>
      </button>
      <button v-if="auth.isAdmin" :class="['tab-item', { active: tab === 'users' }]" @click="tab = 'users'">
        <v-icon size="small" class="tab-icon">mdi-account-group</v-icon>
        <span>用户管理</span>
      </button>
      <button :class="['tab-item', { active: tab === 'profile' }]" @click="tab = 'profile'">
